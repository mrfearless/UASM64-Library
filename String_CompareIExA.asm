...
; strings for a difference. This is the Ansi version of String_CompareIEx, 
; String_CompareIExW is the Unicode version.
;
; Parameters:
; 
...
; See Also:
;
; String_CompareA, String_CompareIA
; 
;------------------------------------------------------------------------------
String_CompareIExA PROC FRAME USES RBX RCX RDX RDI RSI R8 lpszCaseInsensitiveString1:QWORD, lpszCaseInsensitiveString2:QWORD, qwLengthString:QWORD
