...
;
;------------------------------------------------------------------------------
String_InString PROC FRAME USES RBX RCX RDX RDI RSI qwStartPosition:QWORD,lpszString:QWORD,lpszSubString:QWORD
    LOCAL sLen:QWORD
    LOCAL pLen:QWORD

    Invoke String_Length, lpszString
